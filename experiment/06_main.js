...
$("document").ready(function() {
    ...
    window.magpie_monitor = magpieInit({
        ...
        // attention2 includes information about player levels
        views_seq: [
            instructions,
            instructions3,
            prolific_id,
        ...
        deploy: {
            ...
            experimentID: "3",
            serverAppURL: "https://magpie-backend-3.herokuapp.com/api/submit_experiment/",
            ...
            deployMethod: "debug",
            contact_email: "angelacao@outlook.com",
